...
bool window_create_from_handle(void *handle, float scale, unsigned flags) {
    ...
    flags |= optioni("--vsync", DEFAULT_VSYNC) || flag("--vsync") ? WINDOW_VSYNC : WINDOW_VSYNC_DISABLED;
    ...
    int max_blocks[2] = {0}, max_size = 0, max_image_texture_units = 0;
